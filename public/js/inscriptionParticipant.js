$("#sendButton").click(() => {
    if (($("#nom").val().trim() == "" || $("#prenoms").val().trim() == "" || $("#datenaissance").val().trim() == "" || $("#mail").val().trim() == "" || $("#contact").val().trim() == "" || $("#compweb").val().trim() == "" || $("#compmobile").val().trim() == "" || $("#compia").val().trim() == "" || $("#compdesign").val().trim() == "")) {
        $('#modal').modal("show")
    } else {
        var data = {
            type: "Participant",
